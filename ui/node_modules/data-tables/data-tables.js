       ...
       $scope.prePage = function() {
		...
		// require: 'ngModel', // Array = multiple requires, ? = optional, ^ = check parent elements
		 ...
		 template: function(iElm, attrs) {
            ...
            repeatString = repeatItem +" in filtered = ( filtered_search = (" + repeatData + customFilter + " | filter:$search | orderBy:$field:$reverse) | startFrom:$currentPage*$pageSize | limitTo:$pageSize | orderBy:'+':true )";
